...
contract StrategyValasChefLP is StratManager, FeeManager {
    ...
    address constant public chef = address(0x3eB63cff72f8687f8DE64b2f0e40a5B95302D028);
    address constant public feeDistribution = address(0x685D3b02b9b0F044A3C01Dbb95408FC2eB15a3b3);
    ...
    function rewardsAvailable() public view returns (uint256) {
        address[] memory tokens = new address[](1);
        tokens[0] = want;
        return IBlizzMasterChef(chef).claimableReward(address(this), tokens)[0].div(4);
    }
