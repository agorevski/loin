...
contract StrategyValas is StratManager, FeeManager {
    ...
    address public dataProvider = address(0xb5f344F568b714c471B23924644B4e393Ca4E9E9);
    address public lendingPool = address(0xE29A55A6AEFf5C8B1beedE5bCF2F0Cb3AF8F91f5);
    IBlizzMultiFeeDistribution public feeDistribution = IBlizzMultiFeeDistribution(0x685D3b02b9b0F044A3C01Dbb95408FC2eB15a3b3);
    IBlizzIncentivesController public incentivesController = IBlizzIncentivesController(0xB7c1d99069a4eb582Fc04E7e1124794000e7ecBF);
    ...
    function rewardsAvailable() public view returns (uint256) {
        ...
        return reward[0].add(reward[1]).div(4);
    }
