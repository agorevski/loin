...
export const DaoNavItems: NavItemConfig[] = [
  ...
  },
  {
    ...
    url: 'https://snapshot.box/#/s:profit.loin.eth/',
...
export const ResourcesNavItems: NavItemConfig[] = [
  {
    title: 'Header-News',
    Icon: NewsIcon,
    url: 'https://loin.com/articles/',
    Component: ArticlesNavItem,
  },
  { title: 'Header-MediaKit', Icon: MediaKitIcon, url: 'https://loin.com/media-kit/' },
  { title: 'Header-Partners', Icon: PartnersIcon, url: 'https://loin.com/partners' },
  { title: 'Header-Analytics', Icon: AnalyticsIcon, url: 'https://analytics.loin.finance/' },
  { title: 'Header-Gems', Icon: GemsIcon, url: '/campaigns/begems' },
  { title: 'Header-Docs', Icon: DocsIcon, url: 'https://docs.loin.finance/', externalLink: true },
  {
    title: 'Header-Audit',
    Icon: AuditIcon,
    url: 'https://github.com/loinfinance/loin-audits',
    externalLink: true,
  },
];
