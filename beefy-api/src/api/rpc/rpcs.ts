...
const rpcs: Record<ChainId, string[]> = {
  ...
  [ChainId.heco]: ['https://http-mainnet-node.huobichain.com', 'https://http-mainnet.hecochain.com'],
  [ChainId.linea]: [
  ...
  [ChainId.aurora]: ['https://mainnet.aurora.dev', 'https://aurora.drpc.org', 'https://1rpc.io/aurora'],
  [ChainId.mantle]: ['https://rpc.mantle.xyz', 'https://rpc.ankr.com/mantle', 'https://1rpc.io/mantle'],
  [ChainId.fraxtal]: ['https://rpc.frax.com'],
  [ChainId.mode]: ['https://mainnet.mode.network', 'https://mode.drpc.org', 'https://1rpc.io/mode'],
